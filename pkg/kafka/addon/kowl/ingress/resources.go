...
func Resources(ctx *pulumi.Context) error {
	...
	virtualServiceObject := buildVirtualServiceObject(fmt.Sprintf("%s-public", KubeServiceName),
		KubeServiceName, i.namespaceName, i.externalKowlDashboardHostname, i.environmentName, i.kafkaIngressDomain)
	if err := addVirtualService(ctx, virtualServiceObject, svc, i.workspaceDir); err != nil {
...
func addService(ctx *pulumi.Context, i *input) (*corev1.Service, error) {
	svc, err := corev1.NewService(ctx, i.kowlDeploymentName, &corev1.ServiceArgs{
